...
@section('meta_description', 'Rai Raka Express | Jasa Pengiriman Cepat & Terpercaya Ke Luar Negeri')
...
<div class="container">
    <section class="hero card" aria-labelledby="hero-heading">
        <div class="left">
            ...
            <div class="mt-4">
                <a href="{{ url('/contact') }}" class="btn btn-outline">Butuh Bantuan? Hubungi Kami</a>
            </div>
        </div>
