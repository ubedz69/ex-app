...
<div class="container">
    <div class="card">
        <h2 class="hero-title">Layanan Kami</h2>
        <p class="hero-sub">Kami menyediakan berbagai macam layanan logistik sesuai kebutuhan Anda:</p>
        <ul>
            <li><strong>Pengiriman Reguler:</strong> Layanan hemat biaya untuk pengiriman domestik.</li>
            <li><strong>Express & Same-Day:</strong> Pengiriman prioritas untuk kebutuhan mendesak.</li>
            <li><strong>Cargo & Freight:</strong> Pengiriman kargo besar dan muatan berat.</li>
            <li><strong>Fulfillment:</strong> Penyimpanan dan pengiriman pesanan untuk e-commerce.</li>
        </ul>
    </div>
</div>
@endsection
